...
class PDFService:
            ...
            for block in blocks:
                ...
                for line in block["lines"]:
                    ...
                    if prev_y1 is not None:
                        ...
                        print(f"Page {page_num}, Line Text: {line_text}, Gap: {gap}, Line height: {line_height}")
    ...
    def chunk_paragraphs(self, paragraphs: List[str], max_size: int = CHUNK_SIZE) -> List[str]:
        ...
        for para in paragraphs:
            ...
            print(f"Para size: {para_size}, Current size: {current_size}, Potential: {current_size + para_size}, Max: {max_size}")
            print(f"Para text: {para}...")
            ...
            if current_size + para_size > max_size and current_chunk:
                chunks.append('\n\n'.join(current_chunk))
                print(f"Creating chunk of size {len(chunk_text)}")
                current_chunk = []
                current_size = 0
